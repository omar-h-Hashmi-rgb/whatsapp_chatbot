...
import { RootState, Canvas, useFrame, useThree } from "@react-three/fiber";
        ...
        >
            ...
            <div className="relative z-10 flex h-svh w-full items-center justify-center px-6">
                <div className="text-center">
                    ...
                    >
                        Autonomous Scheduling for the Modern Era
                    </h1>
                    <p
                        ref={pRef}
                        className="mx-auto mt-4 max-w-2xl md:text-balance text-sm/6 md:text-base/7 font-light tracking-tight text-white/70"
                    >
                        Experience WhatsApp-style scheduling with intelligent conflict resolution.
                        Our AI handles the logistics, so you can focus on the lesson.
                    </p>
